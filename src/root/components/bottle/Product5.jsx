...
const Product5 = () => {
  ...
  return (
    <section className="first_bootle-buy-page" id="bottle5">
      <div className="buy-page_content5">
        <div className={`image_cont5 ${selectedSize === 1 ? "scaled" : ""}`}>
        ...
        <div className="buy_content5">
          ...
          <div className="buy_page_butt">
            <div className="radio__in_button5">
              <input
                onClick={() => {
          ...
          <div className="bottle_color_change5">
            <fieldset>
